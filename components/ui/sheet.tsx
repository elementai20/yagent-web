...
const sheetVariants = cva(
  'fixed z-30 bg-panel transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-300',
  {
    variants: {
      side: {
...
// Radix requires an accessible title; we render it visually hidden where the
// design has no visible heading.
